...
driver.navigate().to(GlobalVariable.baseUrl + slug)
...
if(!WebUI.waitForElementPresent(findTestObject('SeoContentSearchPage/content-bluebg-section'), 1, FailureHandling.OPTIONAL)){
...
if (WebUI.waitForElementPresent(findTestObject('Mobile Objects/SEO/akordeon-mobile/Akordeon-pierwszy-ele-mobile'), 2, FailureHandling.OPTIONAL)) {
    WebUI.verifyElementPresent(findTestObject('Mobile Objects/SEO/akordeon-mobile/Akordeon-pierwszy-ele-mobile'), 1)

    WebUI.verifyElementVisible(findTestObject('Mobile Objects/SEO/akordeon-mobile/Akordeon-pierwszy-ele-mobile'))
